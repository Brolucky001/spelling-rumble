...
interface AuthPanelProps {
  ...
  onSignUp: (name: string, email: string, password: string, role: Extract<PortalRole, "student" | "school">) => Promise<void>;
}
...
export function AuthPanel({ onSignIn, onSignUp }: AuthPanelProps) {
  ...
  const [role, setRole] = useState<Extract<PortalRole, "student" | "school">>("student");
